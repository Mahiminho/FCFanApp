...
void Profit::on_pushButton_res_clicked()
{
    ...
    long long numf = (ui->lineEdit_numfotballs->text()).toDouble();
    long long pricef = (ui->lineEdit_pricefootballs->text()).toDouble();
    long long matches = (ui->lineEdit_matches->text()).toDouble();
    long long numplaces = (ui->lineEdit_numplaces->text()).toDouble();
    long long ticket = (ui->lineEdit_priceticket->text()).toDouble();

    long long items = numf * pricef + matches * numplaces * ticket;

    long long resi = sum + items;
